...
simpleshare.App = function() {
    var appConfig = new driveapi.AppConfig(simpleshare.config.DRIVE_API_CONFIG_DATA);

    this.presenter_ = new simpleshare.Presenter(appConfig);
 ...
 */
simpleshare.App.prototype.onHtmlBodyLoaded = function() {
 ...
 */
simpleshare.App.prototype.onGapiClientLoaded = function() {
